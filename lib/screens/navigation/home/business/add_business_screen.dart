...
class _AddBusinessScreenState extends State<AddBusinessScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: AppConstant.createNewEntryPlainText,
      ),
      body: initBuildUi(),
    );
  }
            ...
            children: [
              Column(
                ...
                children: [
                  CustomTextFormField(
                      // isMandatory: true,
                      hint: AppConstant.companyNamePlainText,
                  ...
                  CustomTextFormField(
                      // isMandatory: true,
                      hint: AppConstant.ownershipPlainText,
                      ...
                      if (widget.editCompanyInfo == null) {
                        ...
                        if (_imagePath.isNotEmpty) {
                          ...
                          final uploadTask = storageRef
                              .child(
                                  "${GlobalVar.basePath}/${AppConstant.accountPath}/$uniqueName/${AppConstant.userImageName}")
                        ...
                        await Future.delayed(Duration(
                                seconds: _imagePath.isNotEmpty ? 7 : 0))
                            .whenComplete(() async {
                          print(
                          ...
                          DatabaseReference ref = database.ref(
                              "${GlobalVar.basePath}/${AppConstant.accountPath}/${uniqueName}");

                          await ref.set({
                            AppConstant.companyNameColumnText:
                                companyNameController.text,
                            AppConstant.addressColumnText:
                                addressController.text,
                            AppConstant.ownershipColumnText:
                        ...
                        DatabaseReference ref = FirebaseDatabase.instance.ref(
                            "${GlobalVar.basePath}/${AppConstant.accountPath}/${widget.editCompanyInfo!.key}");
                        ref.update({
                          AppConstant.companyNameColumnText:
                              companyNameController.text,
