          ...
          child: Column(
            ...
            children: [
              Column(
                ...
                children: [
                  CustomTextFormField(hint: AppConstant.datePlainText,controller: dateController),
                  SizedBox(height: 10,),
                  CustomTextFormField(hint: AppConstant.entryTitlePlainText,controller: entryTitleController),
                  SizedBox(height: 10,),
                  CustomTextFormField(hint: AppConstant.entryDetailsPlainText,controller: entryDetailsController),
                  SizedBox(height: 10,),
                  CustomTextFormField(hint: AppConstant.moneyAmountPlainText,controller: entryDetailsController),
                  SizedBox(height: 10,),
                  initEntryTypeUI(),
                  SizedBox(height: 10,),
